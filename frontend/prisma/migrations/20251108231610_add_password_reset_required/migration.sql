...
INSERT INTO "new_User" ("accessScope", "approvedAt", "approvedBy", "businessNumber", "companyName", "createdAt", "customRoleId", "customerGroupId", "customerId", "department", "email", "emailVerified", "emailVerifiedAt", "id", "inviteToken", "inviteTokenExpiry", "isActive", "lastLoginAt", "lastLoginIp", "loginCount", "name", "organizationId", "password", "phone", "position", "rejectedReason", "resetToken", "resetTokenExpiry", "role", "status", "updatedAt") SELECT "accessScope", "approvedAt", "approvedBy", "businessNumber", "companyName", "createdAt", "customRoleId", "customerGroupId", "customerId", "department", "email", "emailVerified", "emailVerifiedAt", "id", "inviteToken", "inviteTokenExpiry", "isActive", "lastLoginAt", "lastLoginIp", "loginCount", "name", "organizationId", "password", "phone", "position", "rejectedReason", "resetToken", "resetTokenExpiry", "role", "status", "updatedAt" FROM "User";
DROP TABLE "User";
