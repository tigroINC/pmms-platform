        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
              ...
              <li>• 임시저장 → 임시데이터관리 탭에서 확인 → 확정업로드</li>
        ...
        <div className="space-y-6">
          <div>
            ...
            <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <li>[임시데이터관리] 탭 클릭</li>
              <li>저장된 데이터 목록 확인</li>
              <li>필요시 [Excel 다운로드] 클릭</li>
            </ol>
          </div>

          <div>
            <h3 className="text-lg font-bold mb-3">데이터 검토 및 수정</h3>
            <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <p>다운로드한 Excel 파일에서:</p>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
            ...
            <p className="text-sm text-yellow-800 dark:text-yellow-200">
              ...
              검토 후 확정일괄업로드를 통해 최종 확정해야 측정이력에 반영됩니다.
            </p>
          </div>
        </div>
      )
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="border-b pb-4">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              A: [임시데이터관리] 탭에서 해당 데이터를 삭제 후 다시 입력하세요.<br/>
              또는 같은 날짜/굴뚝/항목으로 다시 임시저장하면 기존 값이 업데이트됩니다.
            </p>
          </div>
          <div className="border-b pb-4">
